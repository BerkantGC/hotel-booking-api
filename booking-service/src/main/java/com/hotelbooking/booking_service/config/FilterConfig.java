...
import com.hotelbooking.booking_service.util.InternalAuthFilter;
import com.hotelbooking.booking_service.util.RoleAuthenticationFilter;
...
public class FilterConfig {
    ...
    public FilterRegistrationBean<InternalAuthFilter> internalFilter(InternalAuthFilter filter) {
        ...
        bean.addUrlPatterns("/api/v1/bookings/*");
        bean.setOrder(1);
        return bean;
    }
